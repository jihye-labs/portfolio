...
Object.assign(imageSets, {
  ...
  "kd-awe-booth-record": staticImage("./assets/kd_navien/1_AWE_1.png", 2200, 1233),
  "kd-awe-facade-comparison": staticImage("./assets/kd_navien/1_AWE_4.png", 1200, 800),
  "kd-awe-onsite-angle": staticImage("./assets/kd_navien/1_AWE_3.jpeg", 971, 728),
  "kd-ish-spatial-proposal": staticImage("./assets/kd_navien/ISH_3d.png", 2666, 1600),
  "kd-ish-onsite-theater": staticImage("./assets/kd_navien/1_ISH.png", 942, 559),
  "kd-ish-experience-zone": staticImage("./assets/kd_navien/1_ISH_2.png", 874, 558),
  "kd-usp-boiler-panel": staticImage("./assets/kd_navien/2.jpeg", 545, 988),
  "kd-mate-heating-pop": staticImage("./assets/kd_navien/2.png", 1200, 800),
  "kd-graphic-system-map": staticImage("./assets/kd_navien/경동_그래픽.png", 1804, 958),
  "kd-shanghai-showroom": staticImage("./assets/kd_navien/2018_경동_쇼룸_상해 .png", 1786, 994),
  "kd-baby-fair-proposal": staticImage("./assets/kd_navien/2017_경동_베이비페어.png", 1778, 986),
  "kd-planning-board": staticImage("./assets/kd_navien/스크린샷 2026-07-05 오후 3.43.22.png", 1812, 772),
...
const projects = {
  ...
  "kd-navien-exhibition": {
    ...
    evidenceGroups: [
      {
        eyebrow: "01 / AWE EXHIBITION",
        layout: "awe-2018",
        title: "AWE turned product technology into a visitor-facing booth system.",
        description: "Large booth views, facade variation, and field angles show how technical product stories became navigable exhibition zones.",
        items: [
          ["kd-awe-booth-record", "KD Navien AWE booth record", "Booth scale and visitor-facing product zones", "50% 50%", "standard"],
          ["kd-awe-facade-comparison", "KD Navien AWE facade comparison", "Facade and product communication variations", "50% 50%", "standard"],
          ["kd-awe-onsite-angle", "KD Navien AWE on-site angle", "Field view of booth presence and visitor path", "50% 50%", "standard"],
        ],
      },
      {
        eyebrow: "02 / ISH EXHIBITION",
        layout: "ish-hero-pair",
        title: "ISH organized the smart-home offer into a clearer experience path.",
        description: "Proposal renderings and on-site records connect spatial storytelling, demonstration logic, and production feasibility.",
        items: [
          ["kd-ish-spatial-proposal", "KD Navien ISH spatial proposal", "Spatial proposal and booth communication hierarchy", "50% 50%", "standard"],
          ["kd-ish-onsite-theater", "KD Navien ISH on-site booth", "Theater-like product storytelling and audience gathering", "50% 50%", "standard"],
          ["kd-ish-experience-zone", "KD Navien ISH experience zone", "Product experience area and branded booth application", "50% 50%", "standard"],
        ],
      },
      {
        eyebrow: "03 / PRODUCT COMMUNICATION",
        layout: "product-feature-stack",
        title: "Technical USP became visible through POP and graphic proof.",
        description: "Boiler, heating-mat, and benefit-map materials translate product functions into fast-read exhibition communication.",
        items: [
          ["kd-usp-boiler-panel", "KD Navien boiler USP panel", "Technical boiler USP translated into a vertical product graphic", "50% 50%", "standard"],
          ["kd-mate-heating-pop", "Navien Mate heating mat POP", "Heating-mat benefit communication for bedding and product display", "50% 50%", "standard"],
          ["kd-graphic-system-map", "KD Navien graphic system map", "Graphic map connecting benefits, product logic, and customer understanding", "50% 50%", "standard"],
        ],
      },
      {
        eyebrow: "04 / RELATED SPATIAL SYSTEM",
        layout: "related-feature-pair",
        title: "The exhibition logic extended into showroom, fair, and planning material.",
        description: "Supporting spatial records show the system moving beyond one booth into showroom, family-facing fair, and planning documentation.",
        items: [
          ["kd-shanghai-showroom", "KD Navien Shanghai showroom", "Showroom application and field standard", "50% 50%", "standard"],
          ["kd-baby-fair-proposal", "KD Navien baby fair proposal", "Family-facing fair booth concept and product display planning", "50% 50%", "standard"],
          ["kd-planning-board", "KD Navien planning board", "Planning document tying exhibition, showroom, and communication standards", "50% 50%", "standard"],
        ],
      },
    ],
  },
...
const evidence = {
  ...
  "kd-navien-exhibition": [
    ["kd-awe-booth-record", "KD Navien AWE booth record", "AWE booth scale and visitor-facing product zones", "50% 50%"],
    ["kd-ish-spatial-proposal", "KD Navien ISH spatial proposal", "Spatial proposal and demonstration logic", "50% 50%"],
    ["kd-usp-boiler-panel", "KD Navien boiler USP panel", "Technical USP translated into a vertical product graphic", "50% 50%"],
    ["kd-shanghai-showroom", "KD Navien Shanghai showroom", "Showroom application and field standard", "50% 50%"],
  ],
  elora: [
