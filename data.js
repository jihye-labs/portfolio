...
const categories = [
  {
    ...
    entries: [
      ...
      entry("alldayfit", "NEW business review / lookbook", "", "alldayfit", "project", "All Day Fit"),
  ...
  },
  {
    ...
    entries: [
      ...
      entry("genz-glitch", "AI beauty brand concept visual study", "", "genz-glitch", "external", "", "", "https://gen-z-glitch.vercel.app/"),
  ...
  },
  {
    ...
    entries: [
      ...
      entry("kd-navien-exhibition", "AWE / ISH exhibition experience", "", "kd-navien-space", "project", "KD Navien China /"),
      entry("lenovo-smart-home", "Smart-home experience", "", "lenovo-smart-home", "project", "Lenovo Smart Home Experience"),
      entry("btl-archive", "", "", "btl-field-system", "archive", "BTL ARCHIVE", "btl-archive"),
    ],
  },
];
...
const projectEditorial = {
  ...
  alldayfit: {
    ...
    ko: {
      thesis: "신사업 조사와 OEM 검토를 AI 기반 골프웨어 비주얼 제안으로 확장했다.",
      problem: "Y사의 OEM 골프웨어 기회가 실제 소비자 제안으로 발전 가능한지 판단해야 했다.",
      strategy: "시장 분석, 타깃 포지셔닝, 제품 방향, 룩북 증거를 하나의 의사결정 흐름으로 연결했다.",
      contribution: "시장과 경쟁 분석, 사업성 검토, 콘셉트 룩북 방향을 구조화했다.",
      result: "고기능·중가 워크레저 포지션을 시각적으로 검토할 수 있는 사업 제안 근거를 만들었다.",
    },
  ...
  "lenovo-smart-home": {
    client: "Lenovo",
    result: "A scenario-led smart-home experience that makes connected products understandable in everyday life.",
    ko: {
      thesis: "스마트홈 기술을 방문자 중심의 데모 공간으로 번역했다.",
      problem: "연결된 제품들이 하나의 이해 가능한 생활 경험으로 느껴져야 했다.",
      strategy: "제품 중심이 아니라 일상 시나리오와 직접 확인할 수 있는 인터랙션 포인트를 중심으로 구성했다.",
      contribution: "공간 내러티브, 제품 존, 보조 커뮤니케이션을 구조화했다.",
      result: "기술 기능을 생활 장면으로 이해할 수 있는 전시 경험을 만들었다.",
    },
  },
  "samsung-sds": {
    client: "Samsung SDS",
...
const aiArchive = [
  ...
  },
  {
    ...
    tone: "etoile",
    accent: "#ffd36a",
    screenshot: "./assets/optimized/elora-keyvisual-1280.webp",
    imagePosition: "50% 50%",
  ...
  },
  {
    ...
    tone: "ddp",
    accent: "#9b6dff",
    screenshot: "./assets/ai-archive/ddp-fashion-preview.png",
    imagePosition: "50% 18%",
  ...
  },
  {
    ...
    tone: "market",
    accent: "#7fffe0",
    screenshot: "./assets/optimized/market-marble-1280.webp",
    imagePosition: "50% 0%",
